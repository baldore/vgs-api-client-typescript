import VGS from "@vgs/api-client"
...
let api = new VGS.Aliases(config);
...
(async () => {
    ...
    let firstAlias = aliases[0]["aliases"][0]["alias"]
    ...
    let revealed = await api.reveal(firstAlias)
